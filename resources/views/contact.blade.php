...
<head>
  ...
  <title>Movingbay &amp; Contact us</title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="contact-info-block text-center">
                        ...
                        <h4>Address</h4>
                        <p class="lead">1st Floor, No.12, Teja Vihar Portion A, Basavanapura Road, Bhattrahalli, Bengaluru (Bangalore) Urban, Karnataka, 560036</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="contact-info-block text-center">
                        ...
                        <h4>Email</h4>
                        <p class="lead">info@movingbay.org</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="contact-info-block text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="name" id="name" required="" placeholder="Enter your name" type="text">
                                    </div>
                                    @if ($errors->has('name'))
                                    <div class="error">
                                        {{ $errors->first('name') }}
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input class="form-control" name="email" id="email" required="" placeholder="Enter your email" type="email">
                                    </div>
                                    @if ($errors->has('email'))
                                    <div class="error">
                                        {{ $errors->first('email') }}
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="subject" id="subject" required="" placeholder="Please enter a subject" type="text">
                                    </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <!-- START MAP -->
                    <div><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d124449.82905956224!2d77.7029078!3d12.9040462!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8f2a8b6cd5e81c2d!2sMoving%20Bay!5e0!3m2!1sen!2sin!4v1646987540176!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
                    <!-- END MAP -->
                </div>
            </div>
        </div>
