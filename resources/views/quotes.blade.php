...
<head>
  ...
  <title>MovingBay: Packers and Movers | Quotes</title>
...
<section class="page-banner-area page-contact">
    ...
    <section class="section" id="contact">
        ...
        <form method="post" action="{{ route('contact.quote') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="fromcountry" name="fromcountry" required="">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <select class="form-control" id="tocountry" name="tocountry" required="">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input class="form-control" id="phone" name="phone" required="" placeholder="Enter your phone number" type="text">
                                </div>
                                @error('phone')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="address_line1" id="address_line1" required="" placeholder="Street address" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- End Input -->
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="address_line2" id="address_line2" required="" placeholder="Address Line 2" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- End Input -->
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="city" id="city" required="" placeholder="City" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- End Input -->
                            ...
                            <div class="col-sm-6 mb-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="state" id="state" required="" placeholder="State/Province/Region" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- End Input -->
                    ...
                    <div class="col-sm-12 mb-12">
                       ...
                       <div class="col-sm-6 mb-6">
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input class="form-control" name="dest_address_line1" id="dest_address_line1" required="" placeholder="Street address" type="text">
                               </div>
                           </div>
                       </div>
                       <!-- End Input -->
                       ...
                       <div class="col-sm-6 mb-6">
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input class="form-control" name="dest_address_line2" id="dest_address_line2" required="" placeholder="Address Line 2" type="text">
                               </div>
                           </div>
                       </div>
                       <!-- End Input -->
                       ...
                       <div class="col-sm-6 mb-6">
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input class="form-control" name="dest_city" id="dest_city" required="" placeholder="City" type="text">
                               </div>
                           </div>
                       </div>
                       <!-- End Input -->
                       ...
                       <div class="col-sm-6 mb-6">
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   <input class="form-control" name="dest_state" id="dest_state" required="" placeholder="State/Province/Region" type="text">
                               </div>
                           </div>
                       </div>
                       <!-- End Input -->
